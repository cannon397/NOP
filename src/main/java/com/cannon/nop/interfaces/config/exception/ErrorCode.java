...
public enum ErrorCode {
    ...
    AUTHORIZATION_HEADER_ERROR("4004","토큰 헤더 오류입니다.", HttpStatus.BAD_REQUEST),

    UNAUTHORIZED_ERROR("4011", "관리자 KEY가 일치하지 않습니다.", HttpStatus.UNAUTHORIZED),
    ACCESS_TOKEN_ERROR("4012", "액세스 토큰 오류입니다.", HttpStatus.UNAUTHORIZED),


    NOT_FOUND_RESOURCE("4041","해당 자원을 찾지 못했습니다.",HttpStatus.NOT_FOUND),
